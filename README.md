...
* It uses h2 for db so no need to setup any external database. To access running application db http://localhost:9091/h2-console/login.jsp (login parameters are in application.properties file)
...
* To create Docker Image  and run it to on docker you can use `Dockerfile`
* you can use "2022-07-05 21:11:24" example for rest end point..
